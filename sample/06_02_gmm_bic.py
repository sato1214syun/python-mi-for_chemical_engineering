...
optimal_number_of_gaussians = numbers_of_gaussian[opt_num_index[0]]
...
# GMM モデリング
model = GaussianMixture(
    n_components=optimal_number_of_gaussians, covariance_type=optimal_covariance_type
)
model.fit(autoscaled_x)
...
cluster_numbers.to_csv(
    f"cluster_numbers_gmm_{optimal_number_of_gaussians}_{optimal_covariance_type}.csv"
)
...
cluster_probabilities.to_csv(
    f"cluster_probabilities_gmm_{optimal_number_of_gaussians}_{optimal_covariance_type}.csv"
)
