...
for iteration in range(iterations):
    ...
    # print(iteration + 1, '/', iterations, ', BIC :', bic_values.min())  # noqa: ERA001
    ...
    for index, sample_number in enumerate(nan_indexes):
        ...
        interpolated_value = (
            mode_of_estimated_mean[0] * x_std[nan_variables[index]]
            + x_mean[nan_variables[index]]
        )
